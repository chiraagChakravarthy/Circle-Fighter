...
public class ListOption extends MenuComponent implements Option{
    ...
    public ListOption(String message, int y, Menu menu, DynamicColor color) {
        super();
        enabled = true;
        this.color = color;
        setMessage(message);
    ...
    public ListOption(String message, int y, Menu menu) {
