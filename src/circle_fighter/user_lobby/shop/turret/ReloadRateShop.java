...
public class ReloadRateShop extends UpgradeMenu {
    private static final int INDEX = BasicUserTurret.RELOAD_RATE;
    public ReloadRateShop(UserLobbyState state) {
        super(state, "Reload Rate", new SolidColor(0, 255, 255));
    }
